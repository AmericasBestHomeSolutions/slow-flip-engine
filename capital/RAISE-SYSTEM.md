# El Doce Capital System

**The capital-raising funnel for the private money lending vertical.**

Two brands, two jobs:

| Brand | Role | Face |
|---|---|---|
| **LONCHANDO** | The movement. Public, loud, culture. Builds audience, trust, and warm relationships at scale. | Merch, music, mindset content, community events |
...
## Stage 0 — Foundation (build once)

Before running the funnel, three assets must exist:

1. **The Approved Language Library.** A single document of pre-approved phrases
   for everything rate- or offer-related: how the 12% is described, how security
...
| Pool | Who | Temperature | First move |
|---|---|---|---|
...
## Stage 2 — The Education Ladder

Each rung earns the next. Nobody gets pitched before rung 3.

| Rung | Asset | Job |
|---|---|---|
| 1 | **Lead magnet:** *"El Doce Explained — how private lending pays 12% while banks pay 4%"* (short PDF/video) | Convert audience attention into a known contact |
| 2 | **Email mini-course** (5 lessons): what private lending is → how a note works → how the slow flip pays for it → how investors are protected → how people get started | Build understanding + document the relationship over time |
| 3 | **"Lonchando Lunch & Learn"** — small-group lunch or webinar: a full deal walkthrough with real numbers from the Proof File, Q&A | Show receipts, surface intent ("Can we talk one-on-one?") |
| 4 | **Deal teardown series** (ongoing content): one past deal per month, actual numbers, what the investor earned | Keep the ladder warm forever |

Education content teaches the *category* (private lending, how notes work).
It never makes the offer. The offer happens in Stage 3, one-on-one, inside
...
### The discovery call (15 min — qualifies, doesn't sell)

1. Their situation: what their money is doing today, what they need from it
2. Their history: ever invested outside the market? What happened?
3. Their number: what amount would be meaningful but not scary?
4. Book the pitch meeting only if scores hold up

### The pitch meeting (45 min, IronStone Legacy materials)
...
The moves, in order, for every objection: **validate → reframe with proof →
invite a smaller step.** Never argue. Scripts below are the approved framings —
deviations go back through the frontier tier + attorney.
...
**Novel objection rule:** any objection not in this table gets logged, answered
with "let me get you a precise answer on that," and routed to the frontier tier
for a compliant scripted response before anyone improvises one.

---

## Stage 5 — Close & Onboarding

1. Soft yes → attorney sends docs same week (momentum matters)
2. Funding → **same-day confirmation** with the El Doce badge on it
3. **Welcome kit:** physical. Handwritten-style note, La Escalera cap or Anthem
   tee, the payment calendar, one page: "what happens next and when you'll hear
   from us." The kit is the first proof the system keeps its word.
4. First payment → personal call, not just a wire. ("First one's in. Eleven more
   this year. Tamo' lonchando.")

---

## Stage 6 — The Nurture Machine (the system carries the relationship)

Design constraint: **Joe is low on Empathy/Woo. The machine supplies the
follow-through; Joe supplies fifteen minutes of voice.** Every touch below is
...
|---|---|---|---|
| Monthly | Payment confirmation + one-line deal note ("Roof went on the Maple St. property — photo attached") | Automation + Haiku tier | Approve |
| Quarterly | Portfolio letter: payments made, deals in progress, one Proof File item (IronStone Legacy letterhead) | Sonnet tier draft, frontier review if numbers/claims change | Approve + sign |
| Annually | Renewal/review call — 30 min, scheduled 60 days before note maturity | Haiku tier preps a one-page brief from CRM history | Make the call |
| Birthday + note anniversary | Short personal message | Haiku tier drafts from CRM notes | Send from his phone |
| 2×/year | Referral moment — after a payment lands: "Who else in your circle should be at the next Lunch & Learn?" | Scripted | Ask it |

### Prospects — 52-week drip

Weekly value email (deal teardowns, mindset, market notes — education pillar
content, zero offers), plus a quarterly personal check-in task on anyone scoring
12+. Prospects fall out of the drip only by unsubscribing or investing.

### The weekly Relationship Hour (calendar-blocked, non-negotiable)

Monday, 60 minutes. The CRM presents the queue: this week's approvals, this
week's calls, anyone gone quiet 90+ days. The hour is the entire manual cost of
the relationship system. Everything else is machine.

---

## Metrics (review monthly)

- New qualified contacts (score ≥ 12) added
- Education-ladder conversion: contact → Lunch & Learn attendee → pitch
